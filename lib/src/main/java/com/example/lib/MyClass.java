...
public class MyClass {
    public static void main(String[] args) {
        ...
        System.out.println("請輸入任意字串(<100)");
        ...
        for (int i = 0; i < InputstringLength; ) {
            ...
            for (int j = 2; j < InputstringLength + 1; ) {
                ...
                if (inputstring.lastIndexOf(inputstring.substring(i, j)) == i) {
                    ...
                    if (LN > LongestLength) {
                        ...
                        LongestStandard = LongestStandard + "," +
        ...
        System.out.println("最長的重複字串:" + LongestStandard);
